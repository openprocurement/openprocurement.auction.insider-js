...
describe('Unit: Testing Filter "formatnumber" - ', function() {
  it('formatnumber should format positive numbers', inject(function($filter) {
    expect($filter('formatnumber')(100000)).toEqual('100\'000.00');
    expect($filter('formatnumber')(10000)).toEqual('10\'000.00');
    expect($filter('formatnumber')(1000)).toEqual('1\'000.00');
    expect($filter('formatnumber')(100)).toEqual('100.00');
    expect($filter('formatnumber')(10)).toEqual('10.00');
    expect($filter('formatnumber')(1)).toEqual('1.00');
  }));
