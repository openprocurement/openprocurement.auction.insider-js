angular.module('auction').config(['$translateProvider',
  function($translateProvider) {
    ...
    $translateProvider.translations('en', {
      ...
      'The amount you suggest should not be less than the greatest bid made during the previous stage.': 'The amount you suggest should not be less than the greatest bid made during the previous stage.',
    ...
    $translateProvider.translations('uk', {
      ...
      'The amount you suggest should not be less than the greatest bid made during the previous stage.': 'Ваша ставка повинна перевищувати ставку переможця етапу закритих цінових пропозицій.',
    ...
    $translateProvider.translations('ru', {
      ...
      'The amount you suggest should not be less than the greatest bid made during the previous stage.': 'Ваша ставка должна превышать ставку победителя этапа закрытых ценовых предложений.',
